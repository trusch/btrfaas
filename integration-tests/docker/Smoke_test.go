...
var _ = Describe("Smoke Test", func() {
	...
	It("should be possible to deploy and call the echo tests", func() {
		runScript(`btrfaasctl --platform docker function deploy ../../examples/echo-shell.yaml`)
		runScript(`btrfaasctl --platform docker function deploy ../../examples/echo-go/function.yaml`)
		runScript(`btrfaasctl --platform docker function deploy ../../examples/echo-python/function.yaml`)
		runScript(`btrfaasctl --platform docker function deploy ../../examples/echo-node/function.yaml`)
	...
	It("should be possible to deploy a function with an environement variable", func() {
		runScript("btrfaasctl --platform docker function deploy ../../examples/with-env.yaml")
	...
	It("should be possible to deploy and access a secret", func() {
		...
		runScript("btrfaasctl --platform docker function deploy ../../examples/with-secret.yaml")
	...
	It("should be possible to deploy and access a function with options", func() {
		runScript("btrfaasctl --platform docker function deploy ../../examples/sed.yaml")
